...
public class Shooter extends PIDSubsystem {
    ...
    DoubleSolenoid ballReleasePiston = RobotMap.shooterBallReleasePiston;
    ...
    public void raisePiston() {
        ballReleasePiston.set(DoubleSolenoid.Value.kForward);
    }
    
    public void lowerPiston() {
        ballReleasePiston.set(DoubleSolenoid.Value.kReverse);
    }
